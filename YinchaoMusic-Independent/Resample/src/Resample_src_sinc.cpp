...
#include "Resample_fastest_coeffs.h"
#include "Resample_mid_qual_coeffs.h"
#include "Resample_high_qual_coeffs.h"
...
{
	switch (src_enum)
	{	case SRC_SINC_BEST_QUALITY_ST :
			return "Best Sinc Interpolator" ;

		case SRC_SINC_MEDIUM_QUALITY_ST :
			return "Medium Sinc Interpolator" ;

		case SRC_SINC_FASTEST_ST :
