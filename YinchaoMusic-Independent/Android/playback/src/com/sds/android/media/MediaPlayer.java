...
public class MediaPlayer {
	...
	private native int setAudioImpulsePath(int playerRef, String impulsePath,int flag/*路径或文件标志，方面以后扩展多种混响*/);
     ...
     * @param path 文件名或目录路径
	   @param flag 文件名或目录标识
     */
    public int setAudioImpulsePath(String path,int flag) {
    
    	return setAudioImpulsePath(mInteralPlayer, path, flag);
    }
