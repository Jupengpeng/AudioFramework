class _FV3_(irbase)
{
 public:
  ...
  virtual void processreplace(_fv3_float_t *inputL, _fv3_float_t *inputR, _fv3_float_t *outputL, _fv3_float_t *outputR,
 ...
 protected:
  _fv3_float_t wet, wetdB, dry, drydB, width, lrbalance,
    wet1, wet2, wet1L, wet2L, wet1R, wet2R;
