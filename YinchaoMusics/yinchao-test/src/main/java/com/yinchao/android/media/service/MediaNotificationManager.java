...
public class MediaNotificationManager extends BroadcastReceiver {
    ...
    private final YCMusicPlayService mService;
    ...
    public MediaNotificationManager(YCMusicPlayService service) throws RemoteException {
        mService = service;
        updateSessionToken();
...
//                Color.DKGRAY);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        switch (action) {
            ...
            case ACTION_STOP_CASTING:
                Intent i = new Intent(context, YCMusicPlayService.class);
                i.setAction(YCMusicPlayService.ACTION_CMD);
                i.putExtra(YCMusicPlayService.CMD_NAME, YCMusicPlayService.CMD_STOP_CASTING);
    ...
    private PendingIntent createContentIntent(MediaDescriptionCompat description) {
        Intent openUI = new Intent(mService, BindTestActivity.class);
...
//            }
        ...
        if (mController != null && mController.getExtras() != null) {
            String castName = mController.getExtras().getString(YCMusicPlayService.EXTRA_CONNECTED_CAST);
            if (castName != null) {
