...
class ISTDataReaderItf : public ISTInterface
{   
public:
	enum DataReaderId
	{
...
public:
	...
	* \return					操作状态
	*/
	virtual STInt				Open(const STChar* aUrl) = 0;
	...
	*/
	virtual STInt				Read(STUint8* aReadBuffer, STInt aReadPos, STInt aReadSize) = 0;
