...
#ifndef RESAMPLE_COMMON_H_INCLUDED
#define RESAMPLE_COMMON_H_INCLUDED
...
/* In src_linear.c */
const char* linear_get_name_st (int src_enum) ;
const char* linear_get_description_st (int src_enum) ;

int linear_set_converter_st (SRC_PRIVATE *psrc, int src_enum) ;
